 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition null_constraint_function (g : MetricComponents) (s : StateVector) : R :...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition initially_null (g : MetricComponents) (s : StateVector) : Prop :=...
 *
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition constraint_drift_step (g : MetricComponents)...
 *
 * Depends on: constraint_after_step, null_constraint_function
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition renormalize_null (g : MetricComponents) (s : StateVector) : StateVector...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition needs_renormalization (g : MetricComponents) (s : StateVector) (tol : R...
 *
 * Depends on: null_constraint_function
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition mass_shell_constraint (g : MetricComponents) (s : StateVector) (m : R) ...
 *
 * Depends on: null_constraint_function
 */
 ...
 *
 * Depends on: mass_shell_constraint
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition check_null_constraint (g : MetricComponents) (s : StateVector) : R :=...
 *
 * Depends on: null_constraint_function
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition correct_null_constraint (g : MetricComponents) (s : StateVector) : Stat...
 *
 * Depends on: renormalize_null
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition should_correct (g : MetricComponents) (s : StateVector) (tol : R) : boo...
 *
 * Depends on: needs_renormalization
 */
