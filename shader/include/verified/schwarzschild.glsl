 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition schwarzschild_radius (M : R) : R := 2...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition schwarzschild_isco (M : R) : R := 6...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition photon_sphere_radius (M : R) : R := 3...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition f_schwarzschild (r M : R) : R := 1 - (2...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:schwarzschild_metric returns mkMetric(- f)... for g_tt...
 *
 * Depends on: f_schwarzschild
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:schwarzschild_metric returns mkMetric(..., 1/f, ...) for g_rr...
 *
 * Depends on: f_schwarzschild
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:g_thth := r^2...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:g_phph := r^2...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition christoffel_t_tr (r M : R) : R :=...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition christoffel_r_tt (r M : R) : R :=...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition christoffel_r_rr (r M : R) : R :=...
 */
 ...
 * Gamma^r_{thth} = -(r - 2M)
 *
 * Rocq Derivation: Derived from Rocq:Definition christoffel_r_thth (r M : R) : R := -(r - 2...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition christoffel_r_phph (r theta M : R) : R :=...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition christoffel_th_rth (r : R) : R := 1 / r....
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition christoffel_th_phph (theta : R) : R :=...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition christoffel_ph_rph (r : R) : R := 1 / r....
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition christoffel_ph_thph (theta : R) : R :=...
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition radial_acceleration (r dr dtheta dphi theta M : R) : R :=...
 *
 * Depends on: christoffel_r_phph, christoffel_r_rr, christoffel_r_thth, christoffel_r_tt
 */
 ...
 *
 * Rocq Derivation: Derived from Rocq:Definition kretschmann_schwarzschild (r M : R) : R :=...
 */
 ...
 *
 * Depends on: schwarzschild_radius
 */
 ...
 *
 * Depends on: photon_sphere_radius
 */
