...
for tauA in [0.01, 0.03, 0.1, 0.3]:
    for tauF in [10.0, 1000.0]:
        for _ in range(8):
            ...
            aI = tauA; frac = random.uniform(0.0, 0.9); ang = random.uniform(0, 2 * mp.pi)
            ...
            rows.append([tauA * 1e4 + tauF, ds] + vals + [mp.nstr(y[i], 30) for i in range(4)])
with open("ref_mid.csv", "w", newline="") as f:
