...
inline void schwarzschildFHighway(const double *HWY_RESTRICT radii, double rS,
                                  double *HWY_RESTRICT out, std::size_t count) {
...
inline void redshiftBatchHighway(const double *HWY_RESTRICT radii, double rS,
                                 double *HWY_RESTRICT out, std::size_t count) {
...
inline void christoffelAccelHighway(const double *HWY_RESTRICT rArr,
                                    const double *HWY_RESTRICT drArr,
                                    const double *HWY_RESTRICT dthetaArr,
                                    const double *HWY_RESTRICT dphiArr,
                                    const double *HWY_RESTRICT thetaArr, double rS,
                                    double *HWY_RESTRICT accelOut, std::size_t count) {
