 ...
 */
[[nodiscard]] inline TimeSeriesMetadata buildTimeseriesMetadata(const double *times,
                                                                uint32_t nDumps) {
 ...
 */
[[nodiscard]] inline InterpolationState getInterpolationState(const TimeSeriesMetadata &ts,
                                                              double tQuery) {
 ...
 */
[[nodiscard]] inline double hermiteInterpolate(double t, double p0, double p1, double p2,
                                               double p3) {
...
[[nodiscard]] inline double interpolateField(const TimeSeriesMetadata &ts,
                                             const double *fieldValues, double tQuery,
  ...
  if (!useHermite) {
    return linearInterpolate(state.alpha, fieldValues[state.dumpLeft],
 ...
 */
[[nodiscard]] inline double advanceTime(const TimeSeriesMetadata &ts, double tCurrent, double dt,
 ...
 */
[[nodiscard]] inline PlaybackState createPlaybackState(const TimeSeriesMetadata &ts,
                                                       double speed = 1.0) {
  PlaybackState ps;
