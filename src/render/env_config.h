 ...
 * the scene (BLACKHOLE_SCENE=blackhole|observer-sky) and the observer-sky
 * view (BLACKHOLE_OBSERVER_*), the compare/parity sweep, forced
...
/** @brief Scene named by a BLACKHOLE_SCENE value: "blackhole" or "observer-sky". */
