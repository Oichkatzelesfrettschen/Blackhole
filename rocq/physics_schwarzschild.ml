...
(** val christoffel_r_thth :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let christoffel_r_thth r m =
  RbaseSymbolsImpl.coq_Ropp
    (rminus r (RbaseSymbolsImpl.coq_Rmult (iZR (Zpos (XO XH))) m))

(** val christoffel_r_phph :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let christoffel_r_phph r theta m =
  RbaseSymbolsImpl.coq_Rmult
    (RbaseSymbolsImpl.coq_Ropp
      (rminus r (RbaseSymbolsImpl.coq_Rmult (iZR (Zpos (XO XH))) m)))
    (pow0 (sin theta) (succ (succ 0)))

(** val christoffel_th_rth :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let christoffel_th_rth r =
  rdiv (iZR (Zpos XH)) r

(** val christoffel_th_phph :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let christoffel_th_phph theta =
  RbaseSymbolsImpl.coq_Rmult (RbaseSymbolsImpl.coq_Ropp (sin theta))
    (cos theta)

(** val christoffel_ph_rph :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let christoffel_ph_rph r =
  rdiv (iZR (Zpos XH)) r

(** val christoffel_ph_thph :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let christoffel_ph_thph theta =
  rdiv (cos theta) (sin theta)

(** val radial_acceleration :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let radial_acceleration r dr dtheta dphi theta m =
  rminus
    (rminus
      (rminus
        (RbaseSymbolsImpl.coq_Rmult
          (RbaseSymbolsImpl.coq_Ropp (christoffel_r_tt r m)) (iZR (Zpos XH)))
        (RbaseSymbolsImpl.coq_Rmult
          (RbaseSymbolsImpl.coq_Rmult (christoffel_r_rr r m) dr) dr))
      (RbaseSymbolsImpl.coq_Rmult
        (RbaseSymbolsImpl.coq_Rmult (christoffel_r_thth r m) dtheta) dtheta))
    (RbaseSymbolsImpl.coq_Rmult
      (RbaseSymbolsImpl.coq_Rmult (christoffel_r_phph r theta m) dphi) dphi)
...
(** val schwarzschild_g_thth :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let schwarzschild_g_thth r =
  pow0 r (succ (succ 0))

(** val schwarzschild_g_phph :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let schwarzschild_g_phph r theta =
  RbaseSymbolsImpl.coq_Rmult (pow0 r (succ (succ 0)))
    (pow0 (sin theta) (succ (succ 0)))
