...
(** val omega_axiodilaton :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let omega_axiodilaton omega_m omega_Lambda =
  rminus
    (rminus
...
(** val axiodilaton_hubble_parameter :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let axiodilaton_hubble_parameter h0 z0 omega_m omega_ad alpha =
  RbaseSymbolsImpl.coq_Rmult h0
    (axiodilaton_hubble_normalized z0 omega_m omega_ad alpha)
...
let axiodilaton_comoving_distance c h0 z0 _ _ _ =
  RbaseSymbolsImpl.coq_Rmult (rdiv c h0) z0
...
let axiodilaton_luminosity_distance c h0 z0 omega_m omega_ad alpha =
  RbaseSymbolsImpl.coq_Rmult
    (RbaseSymbolsImpl.coq_Rplus
      (q2R { qnum = (Zpos (XO (XI (XO XH)))); qden = (XO (XI (XO XH))) }) z0)
    (axiodilaton_comoving_distance c h0 z0 omega_m omega_ad alpha)

(** val axiodilaton_angular_diameter_distance :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let axiodilaton_angular_diameter_distance c h0 z0 omega_m omega_ad alpha =
  rdiv (axiodilaton_luminosity_distance c h0 z0 omega_m omega_ad alpha)
    (pow0
      (RbaseSymbolsImpl.coq_Rplus
        (q2R { qnum = (Zpos (XO (XI (XO XH)))); qden = (XO (XI (XO XH))) })
        z0)
...
(** val axiodilaton_equation_of_state :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let axiodilaton_equation_of_state _ _ _ =
  rdiv (q2R { qnum = (Zneg (XO (XI (XO XH)))); qden = (XO (XI (XO XH))) })
    (q2R { qnum = (Zpos (XO (XI (XI (XI XH))))); qden = (XO (XI (XO XH))) })
