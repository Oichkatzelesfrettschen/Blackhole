...
let energy g s =
  rminus
    (RbaseSymbolsImpl.coq_Rmult (RbaseSymbolsImpl.coq_Ropp (g_tt g)) (v0 s))
    (RbaseSymbolsImpl.coq_Rmult (g_tph g) (v3 s))

(** val angular_momentum :
    metric_components -> state_vector -> RbaseSymbolsImpl.coq_R **)

let angular_momentum g s =
  RbaseSymbolsImpl.coq_Rplus (RbaseSymbolsImpl.coq_Rmult (g_phph g) (v3 s))
    (RbaseSymbolsImpl.coq_Rmult (g_tph g) (v0 s))
...
let carter_constant theta a e lz p_theta =
  RbaseSymbolsImpl.coq_Rplus (pow0 p_theta (succ (succ 0)))
    (RbaseSymbolsImpl.coq_Rmult (pow0 (cos theta) (succ (succ 0)))
      (RbaseSymbolsImpl.coq_Rplus
        (RbaseSymbolsImpl.coq_Rmult (pow0 a (succ (succ 0)))
          (RbaseSymbolsImpl.coq_Ropp (pow0 e (succ (succ 0)))))
        (rdiv (pow0 lz (succ (succ 0))) (pow0 (sin theta) (succ (succ 0))))))

(** val effective_potential_schwarzschild :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let effective_potential_schwarzschild r m e l =
  rminus
    (RbaseSymbolsImpl.coq_Rmult
      (rminus (iZR (Zpos XH))
        (rdiv (RbaseSymbolsImpl.coq_Rmult (iZR (Zpos (XO XH))) m) r))
      (RbaseSymbolsImpl.coq_Rplus (iZR (Zpos XH))
        (rdiv (pow0 l (succ (succ 0))) (pow0 r (succ (succ 0))))))
    (pow0 e (succ (succ 0)))

(** val impact_parameter :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let impact_parameter e l =
  rdiv l e

(** val critical_impact_schwarzschild :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let critical_impact_schwarzschild m =
  RbaseSymbolsImpl.coq_Rmult
    (RbaseSymbolsImpl.coq_Rmult (iZR (Zpos (XI XH)))
      (sqrt (iZR (Zpos (XI XH)))))
    m
...
let init_null_geodesic r0 theta0 phi0 dir_r dir_theta dir_phi g =
  let v_t =
    sqrt
      (rdiv
        (RbaseSymbolsImpl.coq_Rplus
          (RbaseSymbolsImpl.coq_Rplus
            (RbaseSymbolsImpl.coq_Rmult (g_rr g) (pow0 dir_r (succ (succ 0))))
  ...
  in
  { x0 = _; x1 = _; x2 = _; x3 = _; v0 = _; v1 = _; v2 = _; v3 = _ }
  ((iZR Z0), r0, theta0, phi0, v_t, dir_r, dir_theta, dir_phi)

(** val compute_geodesic_rhs :
    christoffelAccel -> state_vector -> state_vector **)

let compute_geodesic_rhs =
  geodesic_rhs
...
let compute_angular_momentum =
  angular_momentum

(** val compute_impact_parameter :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let compute_impact_parameter =
  impact_parameter
