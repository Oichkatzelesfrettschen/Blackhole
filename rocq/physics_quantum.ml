...
let entanglement_entropy s_A _ _ =
  s_A

(** val page_curve_entropy :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let page_curve_entropy s_QFT area_dx =
  RbaseSymbolsImpl.coq_Rplus s_QFT
    (rdiv area_dx
...
let throat_pinch_factor r_throat proper_dist =
  rdiv r_throat (RbaseSymbolsImpl.coq_Rplus proper_dist r_throat)
...
let hawking_radiation_entropy t m =
  page_curve t (pow0 m (succ (succ (succ 0)))) m

(** val accessible_information :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let accessible_information =
