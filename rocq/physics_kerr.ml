...
(** val frame_dragging_omega :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let frame_dragging_omega r theta m a =
  rdiv
    (RbaseSymbolsImpl.coq_Rmult
      (RbaseSymbolsImpl.coq_Rmult
        (RbaseSymbolsImpl.coq_Rmult (iZR (Zpos (XO XH))) m) r)
...
(** val ergosphere_radius :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let ergosphere_radius theta m a =
...
(** val photon_orbit_prograde :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let photon_orbit_prograde m a =
  RbaseSymbolsImpl.coq_Rmult
    (RbaseSymbolsImpl.coq_Rmult (iZR (Zpos (XO XH))) m)
    (RbaseSymbolsImpl.coq_Rplus (iZR (Zpos XH))
      (cos
        (RbaseSymbolsImpl.coq_Rmult
          (rdiv (iZR (Zpos (XO XH))) (iZR (Zpos (XI XH))))
          (acos (rdiv (RbaseSymbolsImpl.coq_Ropp a) m)))))

(** val photon_orbit_retrograde :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let photon_orbit_retrograde m a =
  RbaseSymbolsImpl.coq_Rmult
    (RbaseSymbolsImpl.coq_Rmult (iZR (Zpos (XO XH))) m)
    (RbaseSymbolsImpl.coq_Rplus (iZR (Zpos XH))
      (cos
        (RbaseSymbolsImpl.coq_Rmult
          (rdiv (iZR (Zpos (XO XH))) (iZR (Zpos (XI XH)))) (acos (rdiv a m)))))

(** val kerr_christoffel_t_tr :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let kerr_christoffel_t_tr r theta m a =
  let sigma = kerr_Sigma r theta a in
  let delta = kerr_Delta r m a in
  RbaseSymbolsImpl.coq_Rmult
    (rdiv
      (RbaseSymbolsImpl.coq_Rmult m
        (rminus (pow0 r (succ (succ 0)))
          (RbaseSymbolsImpl.coq_Rmult (pow0 a (succ (succ 0)))
            (pow0 (cos theta) (succ (succ 0))))))
      (RbaseSymbolsImpl.coq_Rmult (pow0 sigma (succ (succ 0))) delta))
    (RbaseSymbolsImpl.coq_Rplus (pow0 r (succ (succ 0)))
      (pow0 a (succ (succ 0))))

(** val kerr_christoffel_r_tt :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R ->
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let kerr_christoffel_r_tt r theta m a =
  let sigma = kerr_Sigma r theta a in
  let delta = kerr_Delta r m a in
  rdiv
    (RbaseSymbolsImpl.coq_Rmult (RbaseSymbolsImpl.coq_Rmult m delta)
      (rminus (pow0 r (succ (succ 0)))
        (RbaseSymbolsImpl.coq_Rmult (pow0 a (succ (succ 0)))
          (pow0 (cos theta) (succ (succ 0))))))
    (pow0 sigma (succ (succ (succ 0))))
...
(** val kerr_isco_retrograde :
    RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R -> RbaseSymbolsImpl.coq_R **)

let kerr_isco_retrograde =
